...
ALTER TABLE users ADD COLUMN IF NOT EXISTS payout_currency VARCHAR(10) DEFAULT 'BRL';
ALTER TABLE users ADD COLUMN IF NOT EXISTS bank_name VARCHAR(100);
ALTER TABLE users ADD COLUMN IF NOT EXISTS bank_agency VARCHAR(50);
ALTER TABLE users ADD COLUMN IF NOT EXISTS bank_account VARCHAR(50);
ALTER TABLE users ADD COLUMN IF NOT EXISTS pix_key VARCHAR(100);
